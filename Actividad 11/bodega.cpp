...
void agregar(), buscar(), eliminar(), mostrar(), ordenar(),mostrarPerecederos(), mostrar300(), mostrar50();
...
int main(){
    ...
    do{
        ...
        cout << "5) Mostrar todos los articulos perecederos.\n";
        cout << "6) Mostrar todos los articulos que pesan mas de 300 gramos.\n";
        cout << "7) Mostrar todos los articulos que valen mas de $50.\n";
        cout << "8) Ordenar.\n";
        cout << "9) Salir.\n";
        cout << "Opcion: ";
...
void agregar(){
    ...
    cout << "Es perecedero? (si: s, no: n): "; cin >> unArticulo.perecedero;
...
void mostrar300(){
    ...
    if (existencia==0)
        cout << "No se encontraron articulos de mas de 300 gramos";
}
...
void mostrar50(){
    ...
    if (existencia==0)
        cout << "No se encontraron articulos de mas de $50";
}
